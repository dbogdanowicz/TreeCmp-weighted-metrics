...
/*Reserve zero*/
    ...
    public class LCATable {
        ...
        /**
         * precondition: a,b
         * @param a TaxonRefference ÖĐµÄË÷Ňý
         * @param b TaxonRefference ÖĐµÄË÷Ňý
...
class RootedTriples {
     ...
     * note: 
     * @param ref_a µÚŇ»Ć¬Ę÷Ň¶ÔÚÖ÷łĚĐňµÄĘý×é TaxonRefference 
     * @param ref_b µÚ¶ţĆ¬Ę÷Ň¶ÔÚÖ÷łĚĐňµÄĘý×é TaxonRefference 
     * @param ref_c µÚČýĆ¬Ę÷Ň¶ÔÚÖ÷łĚĐňµÄĘý×é TaxonRefference 
