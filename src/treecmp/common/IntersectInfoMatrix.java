...
public class IntersectInfoMatrix {
    ...
    public short [][] intSize;
    public short [] cSize1;
    public short [] cSize2;
    public BitSet [] intT1toLeafT2;
    public BitSet [] intT2toLeafT1;
    public List<IntVertexPair> eqObjList;
    public boolean [] eqObjT1;
    public boolean [] eqT2;

    public IntersectInfoMatrix(Tree t1, Tree t2, IdGroup idGroup) {
           this.t1 = t1;
           this.t2 = t2;
    ...
    public void init(){
        ...
        intSize = new short[intT1Num][intT2Num];
        ...
        eqObjList = new ArrayList<IntVertexPair>(minIntNodeNum);
        eqObjT1 = new boolean[intT1Num];
        eqT2 = new boolean[intT2Num];
    ...
    public short getT1Int_T2Int(int t1IntId, int t2IntId){
        ...
        return intSize[t1IntId][t2IntId];
    }
    ...
    public void setT1Int_T2Int(int t1IntId, int t2IntId, short intSize){
        ...
        this.intSize[t1IntId][t2IntId] = intSize;

        //check if these are the same objects, eg. clusters or subtrees
        //assume cSize1 and cSize2 have been computed
        if (intSize == cSize1[t1IntId] && intSize == cSize2[t2IntId] ){
            IntVertexPair cp = new IntVertexPair();
            cp.t1IntId = t1IntId;
            cp.t2IntId = t2IntId;
            eqObjList.add(cp);
            //mark that the objects, eg. clusters, subtress have identical equivalents in the other tree
            eqObjT1[t1IntId] = true;
            eqT2[t2IntId] = true;
        }
    }


    public short getSize(Node n1, Node n2){
