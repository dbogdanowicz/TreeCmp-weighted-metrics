...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       // String runtimePathTemp =Main.class.getProtectionDomain().getCodeSource().getLocation().getPath();
        String runtimePathTemp = System.getProperty("user.dir");
       ...
       if(version==null){
           conf = runtimePath + "/config/" + PersistentInfo.configFile;
           dataDir = runtimePath + "/data/" + PersistentInfo.dataPath;
        ...
        if(cmd!=null)
        {
            ...
            TreeReader reader = new FileTreeReader(settings.getInputFile());
